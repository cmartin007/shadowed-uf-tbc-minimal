...
function ShadowUF:LoadDefaultLayout(useMerge)
	...
	config.positions = {
		...
		player = {point = "CENTER", anchorTo = "UIParent", relativePoint = "CENTER", y = -150, x = -89},
	...
	config.units = {
		...
		player = {
			...
			castBar = {enabled = true, order = 60, detachedWidth = 300, detachedHeight = 22, detachedAnchor = { point = "TOP", relativePoint = "BOTTOM", x = 125, y = -80 }},
			xpBar = {order = 55},
		...
		party = {
			...
			portrait = {enabled = true, fullAfter = 50},
			castBar = {order = 60},
			range = {enabled = true, oorAlpha = 0.4, inAlpha = 1.0},
			offset = 23,
			incHeal = {cap = 1},
			incAbsorb = {cap = 1},
			healAbsorb = {cap = 1},
		...
		target = {
			...
			incAbsorb = {cap = 1},
			healAbsorb = {cap = 1},
			castBar = {enabled = true, order = 60, detachedWidth = 300, detachedHeight = 22, detachedAnchor = { point = "TOP", relativePoint = "BOTTOM", x = -115, y = 120}},
